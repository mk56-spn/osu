...
{
    public partial class TestSceneUserTopScoreContainerV2 : OsuTestScene
    {
        [Cached(typeof(IDialogOverlay))]
        private readonly DialogOverlay dialogOverlay;

        public TestSceneUserTopScoreContainerV2()
        {
            UserTopScoreContainerV2<ScoreInfo> topScoreContainer;
