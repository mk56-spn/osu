...
{
    public partial class UserTopScoreContainerV2<TScoreInfo> : VisibilityContainer
    {
        ...
        public UserTopScoreContainerV2(Func<TScoreInfo, LeaderboardScoreV2> createScoreDelegate)
        {
