...
namespace osu.Game.Graphics.UserInterface
{
        ...
        where T : struct, IEquatable<T>, IComparable<T>, IConvertible
    {
        ...
        protected override void UpdateAfterChildren()
        {
            ...
            LeftBox.Scale = new Vector2(Math.Clamp(RangePadding + Nub.DrawPosition.X - (Nub.DrawWidth - 10) / 2f, 0, Math.Max(0, DrawWidth)), 1);
            RightBox.Scale = new Vector2(Math.Clamp(DrawWidth - Nub.DrawPosition.X - RangePadding - (Nub.DrawWidth - 10) / 2, 0, Math.Max(0, DrawWidth)), 1);
        }
